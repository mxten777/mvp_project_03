...
export default function DashboardSection() {
  return (
    <section id="dashboard" className="py-20 bg-gradient-to-br from-blue-50 via-blue-50/30 to-white scroll-mt-24">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((item, idx) => {
            ...
            return (
              <div key={idx} className="card-premium p-6 text-center relative overflow-hidden">
                <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${item.color} opacity-10 rounded-full -mr-12 -mt-12`}></div>
                
                <div className={`inline-flex items-center justify-center w-16 h-16 ${item.bgColor} rounded-2xl mb-4`}>
